...
func (fenixGuiTestCaseBuilderServerObject *fenixExecutionServerObjectStruct) listTestCasesWithFinishedExecutionsLoadFromCloudDB(userID string) (testCasesWithFinishedExecutions []*fenixExecutionServerGuiGrpcApi.TestCaseWithFinishedExecutionMessage, err error) {
