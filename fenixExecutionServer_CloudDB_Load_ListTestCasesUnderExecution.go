...
func (fenixGuiTestCaseBuilderServerObject *fenixExecutionServerObjectStruct) listTestCasesUnderExecutionLoadFromCloudDB(userID string) (testCaseUnderExecutionMessage []*fenixExecutionServerGuiGrpcApi.TestCaseUnderExecutionMessage, err error) {
